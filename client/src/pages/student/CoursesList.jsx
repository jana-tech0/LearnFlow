...
const CoursesList = () => {
  ...
  return (
    <>
     <div className='relative md:px-36 px-8 px-8 pt-20 text-left'>
        ...
        <div>
         {
            input && <div className='inline-flex items-center gap-4 px-4 px-4 px-4 py-3 border mt-8 -mb-8 text-gray-600'>
                <p>{input}</p>
